...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="panel panel-success"> 
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
					<c:forEach items="${empEducation }" var="edu">
						<tr id="sss-${edu.eeduid }">
							<td class="text-center"><input type="checkbox" id="eid-${edu.eeduid }" name="eid-${edu.eeduid }" value="${edu.eid }"></td>
							<td class="text-center">${edu.school }</td> 
							<td class="text-center">${edu.degree }</td>
							<td class="text-center">${edu.major }</td>
							<td class="text-center">${edu.entrance }</td>
							<td class="text-center">${edu.graduation }</td>
							<td class="text-center">
								<button type="button" class="btn btn-primary btn-xs" id="edit-${edu.eeduid}">
	...
	<jsp:include page="/pages/plugins/back/admin/emp/emp_edu_edit_modal.jsp"/>
