				...
				<div class="row">
					...
					<table class="table table-condensed table-striped table-hover">
						...
						<tr>
							...
							<td><pre class="pre-scrollable" style="width:500px;height:100px;">${plan.note}</pre></td>
						</tr>
						<tr>
							<td colspan="2">
							...
							<div class="panel-heading">
								<h4 class="panel-title"> 
									<a data-toggle="collapse" data-parent="news" href="#contentOne">
										<strong><span class="glyphicon glyphicon-user"></span>&nbsp;任务参与人员清单（当前人数：<span id="currentCount">${plan.amount}</span>人）</strong>
									</a>
								</h4>
							</div>
							<div id="contentOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<table class="table table-condensed">
										...
										<tbody>
											<c:forEach items="${allEmpLevelDept}" var="empleveldept">
											<tr id="info-${empleveldept.eid}">
												
									
										
												<td class="text-center">
													<img src="upload/emp/${empleveldept.photo}" style="width:20px;"/> 
												</td> 
												<td class="text-center"><span id="eid--${empleveldept.eid}" style="cursor:pointer;">${empleveldept.ename}</span></td>
												<td class="text-center">${empleveldept.title}</td>
												<td class="text-center">${empleveldept.dname}</td>
												<td class="text-center">${empleveldept.phone}</td>
												<td class="text-center">
													<button type="button" class="btn btn-primary btn-xs" id="remove--${empleveldept.eid}--${pid}">
