...
<script type="text/javascript" src="js/pages/back/admin/finance/finance_supply_apply_list.js"></script>
<%!
	public static final String FINANCE_SUPPLY_APPLY_HANDLE_URL = "pages/back/admin/finance/finance_supply_apply_handle.jsp" ;
%>
					...
					<tbody>
						<tr>
							...
							<td class="text-center">
								<a type="button" class="btn btn-primary btn-xs" href="<%=FINANCE_SUPPLY_APPLY_HANDLE_URL%>?reid=">
