...
<%!
	public static final String PLAN_ADD_URL = "" ;
%>
					...
					<form class="form-horizontal" action="<%=PLAN_ADD_URL%>" id="myform" method="post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group" id="typeDiv">
								<!-- 定义表单提示文字 -->
								<label class="col-md-2 control-label" for="type">任务类型：</label>
								<div class="col-md-7">
									<select id="type" name="type" class="form-control">
										<option value="">====== 请选择任务安排类型 ======</option>
										<option value="1">部门工作安排</option>
										<option value="2">外出洽谈</option>
										<option value="3">部门支撑</option>
										<option value="4">活动&会议</option>
							...
							<div class="form-group" id="startDiv">
								<!-- 定义表单提示文字 -->
								<label class="col-md-2 control-label" for="start">开始时间：</label>
								<div class="col-md-7">
									<!-- 定义表单输入组件 -->
								...
								<!-- 定义表单错误提示显示元素 -->
								<div class="col-md-3" id="startMsg"></div>
							</div>
							<div class="form-group" id="endDiv">
								<!-- 定义表单提示文字 -->
								<label class="col-md-2 control-label" for="end">结束时间：</label>
								<div class="col-md-7">
									<!-- 定义表单输入组件 -->
								...
								<!-- 定义表单错误提示显示元素 -->
								<div class="col-md-3" id="endMsg"></div>
							</div>
							<!-- 定义输入表单样式，其中id主要用于设置颜色样式 -->
