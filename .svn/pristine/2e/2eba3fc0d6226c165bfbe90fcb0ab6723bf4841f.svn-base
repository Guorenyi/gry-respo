...
<%!
	public static final String REIMBURSEMENT_DETAILS_URL = "pages/back/admin/reimbursement/reimbursement_details_list.jsp" ;
	public static final String REIMBURSEMENT_EDIT_URL = "pages/back/admin/reimbursement/reimbursement_edit.jsp" ;
	public static final String REIMBURSEMENT_APPLY_URL = "" ;
%>
				...
				<table class="table table-condensed">
					...
					<tbody>
						<tr>
							...
							<td class="text-center"><span id="re-1" style="cursor:pointer;">出差费用</span></td>
							...
							<td class="text-center">
								<a type="button" class="btn btn-primary btn-xs" href="<%=REIMBURSEMENT_EDIT_URL%>?reid=">
										<span class="glyphicon glyphicon-edit"></span>&nbsp;修改信息</a>
								<a type="button" class="btn btn-primary btn-xs" href="<%=REIMBURSEMENT_DETAILS_URL%>?reid=">
										<span class="glyphicon glyphicon-edit"></span>&nbsp;详情</a>
								<a type="button" class="btn btn-primary btn-xs" href="<%=REIMBURSEMENT_APPLY_URL%>?reid=">
										<span class="glyphicon glyphicon-edit"></span>&nbsp;提交申请</a>
							</td>
						</tr>
					</tbody>
				</table>
				<button class="btn btn-danger" id="rmBtn"><span class="glyphicon glyphicon-remove"></span>&nbsp;删除未处理报销单</button>
