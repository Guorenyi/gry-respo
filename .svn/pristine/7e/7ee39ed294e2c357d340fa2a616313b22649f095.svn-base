...
<%!
	public static final String REIMBURSEMENT_EDIT_URL = "" ;
%>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="<%=REIMBURSEMENT_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
						<fieldset>
